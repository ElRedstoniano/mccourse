...
public class ModArmorItem extends Item {
            ...
            (new ImmutableMap.Builder<ArmorMaterial, List<MobEffectInstance>>())
                    .put(ModArmorMaterials.BISMUTH_ARMOR_MATERIAL,
                            List.of(new MobEffectInstance(MobEffects.HASTE, 400, 2, false, false),
                                    new MobEffectInstance(MobEffects.JUMP_BOOST, 400, 1, false, false))).build();
    ...
    private boolean hasFullSuitOfArmorOn(Player player) {
        ...
        ItemStack leggings = player.getItemBySlot(LEGS);
        ItemStack chestplate = player.getItemBySlot(CHEST);
        ItemStack helmet = player.getItemBySlot(HEAD);
