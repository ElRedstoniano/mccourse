...
public class ModArmorMaterials {
    ...
    public static final ResourceKey<EquipmentAsset> BISMUTH_KEY = ResourceKey.create(REGISTRY_KEY, MCCourse.id("bismuth"));

    public static final ArmorMaterial BISMUTH_ARMOR_MATERIAL = new ArmorMaterial(28, makeDefense(2, 4, 6, 2, 5),
            20, SoundEvents.ARMOR_EQUIP_DIAMOND, 0, 0,
            ModTags.Items.BISMUTH_REPAIRABLES, BISMUTH_KEY);
