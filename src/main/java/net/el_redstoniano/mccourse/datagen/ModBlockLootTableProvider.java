...
public class ModBlockLootTableProvider extends FabricBlockLootSubProvider {
    ...
    public void generate() {
        ...
        //add(ModBlocks.BISMUTH_ORE, block -> createOreDrop(ModBlocks.BISMUTH_ORE, ModItems.RAW_BISMUTH));
        add(ModBlocks.BISMUTH_ORE, multipleOreDrops(ModBlocks.BISMUTH_ORE, ModItems.RAW_BISMUTH, 3, 6));
